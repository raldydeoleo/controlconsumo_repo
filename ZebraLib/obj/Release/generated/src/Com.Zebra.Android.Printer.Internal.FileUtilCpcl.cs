...
namespace Com.Zebra.Android.Printer.Internal {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='FileUtilCpcl']"
	[global::Android.Runtime.Register ("com/zebra/android/printer/internal/FileUtilCpcl", DoNotGenerateAcw=true)]
	public partial class FileUtilCpcl : global::Com.Zebra.Android.Printer.Internal.FileUtilA {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/zebra/android/printer/internal/FileUtilCpcl", typeof (FileUtilCpcl));
		...
		protected FileUtilCpcl (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='FileUtilCpcl']/constructor[@name='FileUtilCpcl' and count(parameter)=1 and parameter[1][@type='com.zebra.android.comm.ZebraPrinterConnection']]"
		[Register (".ctor", "(Lcom/zebra/android/comm/ZebraPrinterConnection;)V", "")]
		public unsafe FileUtilCpcl (global::Com.Zebra.Android.Comm.IZebraPrinterConnection p0)
...
#pragma warning disable 0169
		...
		{
			global::Com.Zebra.Android.Printer.Internal.FileUtilCpcl __this = global::Java.Lang.Object.GetObject<global::Com.Zebra.Android.Printer.Internal.FileUtilCpcl> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='FileUtilCpcl']/method[@name='extractFilePropertiesFromDirResult' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
