...
namespace Com.Zebra.Android.Printer.Internal {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='ZebraPrinterA']"
	[global::Android.Runtime.Register ("com/zebra/android/printer/internal/ZebraPrinterA", DoNotGenerateAcw=true)]
	public abstract partial class ZebraPrinterA : global::Java.Lang.Object, global::Com.Zebra.Android.Printer.IZebraPrinter {



		// Metadata.xml XPath field reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='ZebraPrinterA']/field[@name='connection']"
		[Register ("connection")]
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/zebra/android/printer/internal/ZebraPrinterA", typeof (ZebraPrinterA));
		...
		protected ZebraPrinterA (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='ZebraPrinterA']/constructor[@name='ZebraPrinterA' and count(parameter)=1 and parameter[1][@type='com.zebra.android.comm.ZebraPrinterConnection']]"
		[Register (".ctor", "(Lcom/zebra/android/comm/ZebraPrinterConnection;)V", "")]
		protected unsafe ZebraPrinterA (global::Com.Zebra.Android.Comm.IZebraPrinterConnection p0)
...
#pragma warning disable 0169
		...
		{
			global::Com.Zebra.Android.Printer.Internal.ZebraPrinterA __this = global::Java.Lang.Object.GetObject<global::Com.Zebra.Android.Printer.Internal.ZebraPrinterA> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.CurrentStatus);
		}
#pragma warning restore 0169

		public abstract global::Com.Zebra.Android.Printer.PrinterStatus CurrentStatus {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='ZebraPrinterA']/method[@name='getCurrentStatus' and count(parameter)=0]"
			[Register ("getCurrentStatus", "()Lcom/zebra/android/printer/PrinterStatus;", "GetGetCurrentStatusHandler")] get;
		}
...
#pragma warning restore 0169
		...
		public abstract global::Com.Zebra.Android.Printer.IFileUtil FileUtil {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='ZebraPrinterA']/method[@name='getFileUtil' and count(parameter)=0]"
			[Register ("getFileUtil", "()Lcom/zebra/android/printer/FileUtil;", "GetGetFileUtilHandler")] get;
		}
...
#pragma warning restore 0169
		...
		public abstract global::Com.Zebra.Android.Printer.IFormatUtil FormatUtil {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='ZebraPrinterA']/method[@name='getFormatUtil' and count(parameter)=0]"
			[Register ("getFormatUtil", "()Lcom/zebra/android/printer/FormatUtil;", "GetGetFormatUtilHandler")] get;
		}
...
#pragma warning restore 0169
		...
		public abstract global::Com.Zebra.Android.Printer.IGraphicsUtil GraphicsUtil {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='ZebraPrinterA']/method[@name='getGraphicsUtil' and count(parameter)=0]"
			[Register ("getGraphicsUtil", "()Lcom/zebra/android/printer/GraphicsUtil;", "GetGetGraphicsUtilHandler")] get;
		}
...
#pragma warning restore 0169
		...
		public abstract global::Com.Zebra.Android.Printer.IMagCardReader MagCardReader {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='ZebraPrinterA']/method[@name='getMagCardReader' and count(parameter)=0]"
			[Register ("getMagCardReader", "()Lcom/zebra/android/printer/MagCardReader;", "GetGetMagCardReaderHandler")] get;
		}
...
#pragma warning restore 0169
		...
		public abstract global::Com.Zebra.Android.Printer.PrinterLanguage PrinterControlLanguage {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='ZebraPrinterA']/method[@name='getPrinterControlLanguage' and count(parameter)=0]"
			[Register ("getPrinterControlLanguage", "()Lcom/zebra/android/printer/PrinterLanguage;", "GetGetPrinterControlLanguageHandler")] get;
		}
...
#pragma warning restore 0169
		...
		public abstract global::Com.Zebra.Android.Printer.ISmartcardReader SmartcardReader {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='ZebraPrinterA']/method[@name='getSmartcardReader' and count(parameter)=0]"
			[Register ("getSmartcardReader", "()Lcom/zebra/android/printer/SmartcardReader;", "GetGetSmartcardReaderHandler")] get;
		}
...
#pragma warning restore 0169
		...
		public abstract global::Com.Zebra.Android.Printer.IToolsUtil ToolsUtil {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='ZebraPrinterA']/method[@name='getToolsUtil' and count(parameter)=0]"
			[Register ("getToolsUtil", "()Lcom/zebra/android/printer/ToolsUtil;", "GetGetToolsUtilHandler")] get;
		}

	}

	[global::Android.Runtime.Register ("com/zebra/android/printer/internal/ZebraPrinterA", DoNotGenerateAcw=true)]
	internal partial class ZebraPrinterAInvoker : ZebraPrinterA {

		public ZebraPrinterAInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		internal    new     static  readonly    JniPeerMembers  _members    = new JniPeerMembers ("com/zebra/android/printer/internal/ZebraPrinterA", typeof (ZebraPrinterAInvoker));
