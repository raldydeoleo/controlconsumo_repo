...
namespace Com.Zebra.Android.Printer.Internal {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='FormatUtilZpl']"
	[global::Android.Runtime.Register ("com/zebra/android/printer/internal/FormatUtilZpl", DoNotGenerateAcw=true)]
	public partial class FormatUtilZpl : global::Com.Zebra.Android.Printer.Internal.FormatUtilA {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/zebra/android/printer/internal/FormatUtilZpl", typeof (FormatUtilZpl));
		...
		protected FormatUtilZpl (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='FormatUtilZpl']/constructor[@name='FormatUtilZpl' and count(parameter)=1 and parameter[1][@type='com.zebra.android.comm.ZebraPrinterConnection']]"
		[Register (".ctor", "(Lcom/zebra/android/comm/ZebraPrinterConnection;)V", "")]
		public unsafe FormatUtilZpl (global::Com.Zebra.Android.Comm.IZebraPrinterConnection p0)
...
#pragma warning disable 0169
		...
		{
			global::Com.Zebra.Android.Printer.Internal.FormatUtilZpl __this = global::Java.Lang.Object.GetObject<global::Com.Zebra.Android.Printer.Internal.FormatUtilZpl> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='FormatUtilZpl']/method[@name='getVariableFields' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='FormatUtilZpl']/method[@name='printStoredFormat' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.util.Map&lt;java.lang.Integer, java.lang.String&gt;']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='FormatUtilZpl']/method[@name='printStoredFormat' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.util.Map&lt;java.lang.Integer, java.lang.String&gt;'] and parameter[3][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.zebra.android.printer.internal']/class[@name='FormatUtilZpl']/method[@name='retrieveFormatFromPrinter' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
