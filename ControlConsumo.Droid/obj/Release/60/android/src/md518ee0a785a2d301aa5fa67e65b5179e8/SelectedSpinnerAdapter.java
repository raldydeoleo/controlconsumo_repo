...
public class SelectedSpinnerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ControlConsumo.Droid.Activities.Adapters.SelectedSpinnerAdapter, ControlConsumo.Droid", SelectedSpinnerAdapter.class, __md_methods);
	}


	public SelectedSpinnerAdapter ()
	{
		super ();
		if (getClass () == SelectedSpinnerAdapter.class)
			mono.android.TypeManager.Activate ("ControlConsumo.Droid.Activities.Adapters.SelectedSpinnerAdapter, ControlConsumo.Droid", "", this, new java.lang.Object[] {  });
	}
