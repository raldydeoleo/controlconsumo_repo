...
public class NothingSelectedSpinnerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ControlConsumo.Droid.Activities.Adapters.NothingSelectedSpinnerAdapter, ControlConsumo.Droid", NothingSelectedSpinnerAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == NothingSelectedSpinnerAdapter.class)
			mono.android.TypeManager.Activate ("ControlConsumo.Droid.Activities.Adapters.NothingSelectedSpinnerAdapter, ControlConsumo.Droid", "", this, new java.lang.Object[] {  });
	}
