...
public class StockAdapterExpandable
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ControlConsumo.Droid.Activities.Adapters.StockAdapterExpandable, ControlConsumo.Droid", StockAdapterExpandable.class, __md_methods);
	}


	public StockAdapterExpandable ()
	{
		super ();
		if (getClass () == StockAdapterExpandable.class)
			mono.android.TypeManager.Activate ("ControlConsumo.Droid.Activities.Adapters.StockAdapterExpandable, ControlConsumo.Droid", "", this, new java.lang.Object[] {  });
	}
