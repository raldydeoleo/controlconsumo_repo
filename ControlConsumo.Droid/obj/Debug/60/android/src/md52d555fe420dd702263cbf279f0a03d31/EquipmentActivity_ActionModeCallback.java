...
public class EquipmentActivity_ActionModeCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ControlConsumo.Droid.Activities.EquipmentActivity+ActionModeCallback, ControlConsumo.Droid", EquipmentActivity_ActionModeCallback.class, __md_methods);
	}


	public EquipmentActivity_ActionModeCallback ()
	{
		super ();
		if (getClass () == EquipmentActivity_ActionModeCallback.class)
			mono.android.TypeManager.Activate ("ControlConsumo.Droid.Activities.EquipmentActivity+ActionModeCallback, ControlConsumo.Droid", "", this, new java.lang.Object[] {  });
	}

	public EquipmentActivity_ActionModeCallback (md52d555fe420dd702263cbf279f0a03d31.EquipmentActivity p0, boolean p1)
	{
		super ();
		if (getClass () == EquipmentActivity_ActionModeCallback.class)
			mono.android.TypeManager.Activate ("ControlConsumo.Droid.Activities.EquipmentActivity+ActionModeCallback, ControlConsumo.Droid", "ControlConsumo.Droid.Activities.EquipmentActivity, ControlConsumo.Droid:System.Boolean, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
