...
{
    class ReturnAdapterReprint : BaseAdapter
    {
        ...
        public ReturnAdapterReprint(Context context, IEnumerable<MaterialReport> List)
        {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            holder.txtViewHora.Text = pos.Lot;
        ...
        private async void imgButtonPrint_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    var barcode = String.Format("{0}-{1}-1").GetBarCode();
